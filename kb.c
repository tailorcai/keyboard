...
void keyboard_set_default() {
  ...
  set_key(0, 11, HID_KEY_KEYPAD_1, HID_KEY_NONE);
  set_key(1, 12, HID_KEY_KEYPAD_2, HID_KEY_NONE);
  set_key(2, 13, HID_KEY_KEYPAD_3, HID_KEY_NONE);

  set_key(3, 10, HID_KEY_KEYPAD_4, HID_KEY_NONE);
  set_key(4, 15, HID_KEY_KEYPAD_5, HID_KEY_NONE);
  set_key(5, 14, HID_KEY_KEYPAD_6, HID_KEY_NONE);

  set_key(6, 4, HID_KEY_KEYPAD_7, HID_KEY_NONE);
  set_key(7, 5, HID_KEY_KEYPAD_8, HID_KEY_NONE);
  set_key(8, 6, HID_KEY_KEYPAD_9, HID_KEY_NONE);
